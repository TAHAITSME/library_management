...
urlpatterns = [
    ...
    path('<int:borrow_id>/stripe/success/', views.stripe_success_view, name='stripe_success'),
    path('<int:borrow_id>/stripe/cancel/', views.stripe_cancel_view, name='stripe_cancel'),
